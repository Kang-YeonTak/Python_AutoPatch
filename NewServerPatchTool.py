...
ver = re.compile(r'\d.\d.\d.\d{6}$')           # 버전에 대해 정규식 규칙 생성
...
def pscp_ms(item):
    os.system('pscp -r -pw ' + item[2] + ' ' + patch_ms_path + ' devel@' + item[0] + ':/home/devel/vms')
    os.system('pscp -r -pw ' + item[2] + ' ' + patch_lib_path + ' devel@' + item[0] + ':/home/devel/vms/lib')
    os.system('pscp -r -pw ' + item[2] + ' ' + patch_conf_path + ' devel@' + item[0] + ':/home/devel/vms/conf')
...
def same_list(idx, srv_lst):
    if idx == len(srv_lst) - 1:
        ...
        print(Fore.LIGHTYELLOW_EX + str_next_conn)
